 ...
 * @author Shai Almog
 */
public class QRScannerDemoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "QRScannerDemo";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new QRScannerDemoStub());
    }
